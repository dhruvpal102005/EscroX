...
export const getStatusColor = (status) => {
    const map = {
        "Agreement": "text-blue-600 bg-blue-50 border-blue-200",
        "Funding": "text-amber-600 bg-amber-50 border-amber-200",
        "Verification": "text-purple-600 bg-purple-50 border-purple-200",
        "Inspection": "text-orange-600 bg-orange-50 border-orange-200",
        "Disbursement": "text-teal-600 bg-teal-50 border-teal-200",
    ...
    return map[status] || "text-slate-500 bg-slate-100 border-slate-200";
};
