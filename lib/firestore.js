 ...
 * Supports both service (URL link) and product (tracking ID) types,
 * as well as optional AI verification data.
 *
 * @param {string} contractId
 * @param {string} milestoneId
 * @param {string} value          - For service: evidence URL. For product: tracking ID.
 * @param {string} freelancerName
 * @param {object|string} [aiVerification] - AI result object OR workType string ('service'|'product') for backward compat
 * @param {string} [courier]      - TrackingMore courier slug (product only)
 */
export async function submitMilestone(contractId, milestoneId, value, freelancerName, aiVerification = null, courier = null) {
