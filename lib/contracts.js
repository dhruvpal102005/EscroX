// Chain-31337 (Hardhat localhost) deployment
// Source: ignition/deployments/chain-31337/deployed_addresses.json
// NOTE: 0x5FbDB... is the MockV3Aggregator — the actual Escrow contract is below
...
export const ESCROW_ABI = [
    ...
    },
    {
        ...
        "inputs": [
            ...
            { "indexed": false, "internalType": "uint256", "name": "amountReleasedETH", "type": "uint256" }
        ],
    ...
    },
    {
        ...
        "inputs": [
            ...
            { "indexed": false, "internalType": "uint256", "name": "totalUSD",   "type": "uint256" },
    ...
    },
    {
        ...
        "inputs": [
            { "indexed": true,  "internalType": "uint256", "name": "projectId",       "type": "uint256" },
            { "indexed": false, "internalType": "uint256", "name": "refundAmountETH", "type": "uint256" }
        ],
    ...
    },
    {
        "inputs": [
            ...
            { "internalType": "uint256[]", "name": "_milestoneAmountsUSD", "type": "uint256[]" }
        ],
        "name": "createProject",
        "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],
